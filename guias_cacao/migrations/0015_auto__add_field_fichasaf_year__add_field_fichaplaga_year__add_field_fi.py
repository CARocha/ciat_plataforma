...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FichaSaf.year'
        db.add_column(u'guias_cacao_fichasaf', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaPlaga.year'
        db.add_column(u'guias_cacao_fichaplaga', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaSuelo.year'
        db.add_column(u'guias_cacao_fichasuelo', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaSombra.year'
        db.add_column(u'guias_cacao_fichasombra', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaVivero.year'
        db.add_column(u'guias_cacao_fichavivero', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaCierre.year'
        db.add_column(u'guias_cacao_fichacierre', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaPiso.year'
        db.add_column(u'guias_cacao_fichapiso', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaCosecha.year'
        db.add_column(u'guias_cacao_fichacosecha', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaPoda.year'
        db.add_column(u'guias_cacao_fichapoda', 'year',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FichaSaf.year'
        db.delete_column(u'guias_cacao_fichasaf', 'year')

        # Deleting field 'FichaPlaga.year'
        db.delete_column(u'guias_cacao_fichaplaga', 'year')

        # Deleting field 'FichaSuelo.year'
        db.delete_column(u'guias_cacao_fichasuelo', 'year')

        # Deleting field 'FichaSombra.year'
        db.delete_column(u'guias_cacao_fichasombra', 'year')

        # Deleting field 'FichaVivero.year'
        db.delete_column(u'guias_cacao_fichavivero', 'year')

        # Deleting field 'FichaCierre.year'
        db.delete_column(u'guias_cacao_fichacierre', 'year')

        # Deleting field 'FichaPiso.year'
        db.delete_column(u'guias_cacao_fichapiso', 'year')

        # Deleting field 'FichaCosecha.year'
        db.delete_column(u'guias_cacao_fichacosecha', 'year')

        # Deleting field 'FichaPoda.year'
        db.delete_column(u'guias_cacao_fichapoda', 'year')
