...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ciclos'
        db.create_table(u'guias_cacao_ciclos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ciclo', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'guias_cacao', ['Ciclos'])

        # Adding field 'FichaSaf.ciclo'
        db.add_column(u'guias_cacao_fichasaf', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaPlaga.ciclo'
        db.add_column(u'guias_cacao_fichaplaga', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaSuelo.ciclo'
        db.add_column(u'guias_cacao_fichasuelo', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaSombra.ciclo'
        db.add_column(u'guias_cacao_fichasombra', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaVivero.ciclo'
        db.add_column(u'guias_cacao_fichavivero', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaCierre.ciclo'
        db.add_column(u'guias_cacao_fichacierre', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaPiso.ciclo'
        db.add_column(u'guias_cacao_fichapiso', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaCosecha.ciclo'
        db.add_column(u'guias_cacao_fichacosecha', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'FichaPoda.ciclo'
        db.add_column(u'guias_cacao_fichapoda', 'ciclo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['guias_cacao.Ciclos'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Ciclos'
        db.delete_table(u'guias_cacao_ciclos')

        # Deleting field 'FichaSaf.ciclo'
        db.delete_column(u'guias_cacao_fichasaf', 'ciclo_id')

        # Deleting field 'FichaPlaga.ciclo'
        db.delete_column(u'guias_cacao_fichaplaga', 'ciclo_id')

        # Deleting field 'FichaSuelo.ciclo'
        db.delete_column(u'guias_cacao_fichasuelo', 'ciclo_id')

        # Deleting field 'FichaSombra.ciclo'
        db.delete_column(u'guias_cacao_fichasombra', 'ciclo_id')

        # Deleting field 'FichaVivero.ciclo'
        db.delete_column(u'guias_cacao_fichavivero', 'ciclo_id')

        # Deleting field 'FichaCierre.ciclo'
        db.delete_column(u'guias_cacao_fichacierre', 'ciclo_id')

        # Deleting field 'FichaPiso.ciclo'
        db.delete_column(u'guias_cacao_fichapiso', 'ciclo_id')

        # Deleting field 'FichaCosecha.ciclo'
        db.delete_column(u'guias_cacao_fichacosecha', 'ciclo_id')

        # Deleting field 'FichaPoda.ciclo'
        db.delete_column(u'guias_cacao_fichapoda', 'ciclo_id')
    ...
    models = {
        ...
        u'guias_cacao.ciclos': {
            'Meta': {'object_name': 'Ciclos'},
            'ciclo': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'guias_cacao.fichacierre': {
            ...
            'ciclo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['guias_cacao.Ciclos']", 'null': 'True', 'blank': 'True'}),
